<div class="main-sidebar">
  <aside id="sidebar-wrapper">
    <div class="sidebar-brand">
      <a href="/nakes/dashboard"><img src="{{ asset('img/logo1_copy.png') }}" alt="logo" height="60px" style="margin-bottom=:5px;" ></a>
    </div>
    <div class="sidebar-brand sidebar-brand-sm">
      <a href="/nakes/dashboard"><img src="{{ asset('img/logo.png') }}" alt="logo" height="30px"  ></a>
    </div>
